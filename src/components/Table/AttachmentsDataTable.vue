            ...
            <draggable
              ...
              <template #item="{element}">
                <tr :class="{'cursor-move': !isDragDisabled}">
                  ...
                  <td class="border-t-0 px-3 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4" v-if="!isTask" width="15%">
                  ...
                  <td class="border-t-0 px-3 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4" width="20%">
                  ...
                  <td class="border-t-0 px-3 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4" width="5%">
                    <button
                        @click=downloadTemplate(element.file_path)
