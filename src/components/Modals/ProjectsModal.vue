        ...
        <div class="relative p-6 flex-auto">
          ...
          <div v-else class="content">
            <div class="relative mb-6">
              ...
              <input v-model="filter.search.value" type="text"
            ...
            <ul v-if="projects.length">
              <li v-for="project in projects" :key="project.id" class="flex justify-between items-center gap-x-1 my-3">
                ...
                <button :class="{ 'bg-red-600': project?.id === projectId, 'bg-emerald-600': project?.id !== projectId }"
                  ...
                  type="button" @click="updateProject(project?.id === projectId ? null : project?.id)">
            ...
            <Pagination v-if="paginate.pagination.value.total > 1 && !loading" :pagination="paginate.pagination.value"
